...
//            Text("Value: \(x)")
            ...
            Canvas { context, size in
                context.fill(self.path(in: CGRect(x: 0, y: 0,
                                                  width: size.width,
                                                  height: size.height),
                                       x: x,
                                       x2: x2),
    ...
    func path(in rect: CGRect, x: Double, x2: Double) -> Path {
        ...
        path.addCurve(to: CGPoint(x: 0.6355 * width * x, y: height),
        ...
        path.addCurve(to: CGPoint(x: 0.08995 * width, y: 0.60171 * height),
                      ...
                      control2: CGPoint(x: 0.2695 * width, y: 0.77304 * height * x2))
        path.addCurve(to: CGPoint(x: 0.34086 * width, y: 0.06324 * height),
                      control1: CGPoint(x: -0.0896 * width * x, y: 0.43038 * height),
